...
int main(int argc, char *argv[])
{
    if(argc != 2)
    {
        ...
        cout<<"         7 --> function_7() - Timepix vs Time"<<endl;
        cout<<"         8 --> function_8() - BLM, BCTDC vs LHC Coll position, Timepix vs Time"<<endl;
        cout<<endl;
    }
    else
    {
...
void function_8()
{
    cout<<endl<<">>> function_8() <<<"<<endl;

     //=============================================================//
    // Collimator Linear Scan AM
    // 2018_09_17
//    TString output_file_name    = "output_function_8_RP1.root";
//    TString input_file_tpx      = "output_function_1_RP1_am.root";
//    TString input_file_motor    = "crystal3_am_collimator_linear_scan_2018_09_17.root";
//    TString input_file_blm      = "blm1_crystal3_am_collimator_linear_scan_2018_09_17.root";
//    TString input_file_bctdc    = "bctdc_crystal3_am_collimator_linear_scan_2018_09_17.root";
//    Long64_t minUnixTime_run    = 1537239635;
//    Long64_t maxUnixTime_run    = 1537240164;
//    Int_t posBins               = 3500;
//    Double_t posLimMin          = -35.0;
//    Double_t posLimMax          = 0.0;

    // Collimator Linear Scan CH
    // 2018_09_17
    TString output_file_name    = "output_function_8_RP1.root";
    TString input_file_tpx      = "output_function_1_RP1_ch.root";
    TString input_file_motor    = "crystal3_ch_collimator_linear_scan_2018_09_17.root";
    TString input_file_blm      = "blm1_crystal3_ch_collimator_linear_scan_2018_09_17.root";
    TString input_file_bctdc    = "bctdc_crystal3_ch_collimator_linear_scan_2018_09_17.root";
    Long64_t minUnixTime_run    = 1537240613;
    Long64_t maxUnixTime_run    = 1537241139;
    Int_t posBins               = 3500;
    Double_t posLimMin          = -35.0;
    ...
    TH2D* hh_1   = new TH2D("hh_1","RP1 Internal YX [mm]",N_PIXELS,0,N_PIXELS*PIXEL_SIZE,N_PIXELS,0,N_PIXELS*PIXEL_SIZE);
    TH2D* hh_2   = new TH2D("hh_2","RP1 Internal Y vs Time",maxUnixTime_run-minUnixTime_run,0,maxUnixTime_run-minUnixTime_run,N_PIXELS,0,N_PIXELS*PIXEL_SIZE);
    TH2D* hh_10 = new TH2D("hh_10","Collimator Position vs UnixTime",(maxUnixTime_run-minUnixTime_run),minUnixTime_run,maxUnixTime_run,posBins,posLimMin,posLimMax);
    ...
    for(Int_t eventID = 1; eventID < nEntries_2; eventID++)
    {
        ...
        Double_t position_temp = gr_0->Eval(untime_blm);
        Double_t gradInt = TMath::Abs((fit1->Eval(timeOld) - fit1->Eval(untime_blm))/(untime_blm - timeOld));

        gr_3->SetPoint(gr_3_iter,position_temp,blm/gradInt);
    ...
    TH2D* hh_2_2   = new TH2D("hh_2_2","RP1 Internal Y vs Position",maxUnixTime_run-minUnixTime_run,gr_0->Eval(minUnixTime_run),gr_0->Eval(maxUnixTime_run),N_PIXELS,0,N_PIXELS*PIXEL_SIZE);
