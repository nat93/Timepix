...
#################################################
#												#
# USAGE: python script.py folder_date date		#
#												#
# folder_date and date format: yyyy_mm_dd		#
#												#
#################################################
...
#path = '/media/dfs/Experiments/UA9/Data_SPS_runs/MD_'+sys.argv[1]+'/Detectors Data/CpFMCounters_*.csv'
path = '/home/petruccs-local/sps/MD_'+sys.argv[1]+'/Detectors Data/CpFMCounters_*.csv'
counternames = []
timestamps = []
countervalues = {}
folder = []
...
for infile in sorted(glob.glob(path), key=numericalSort):
